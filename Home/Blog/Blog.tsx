...
const Blog = () => {
  return (
    <section className="bg-white px-4 pt-6 pb-[54px] sm:px-6 lg:px-8 lg:pb-[64px]">
      {/* HEADING */}
      <Heading
        subtitle="Update The New Trend"
          ...
          {posts.map((post, index) => (
            <article
              ...
              className={`group text-center ${
                index === 2
                  ? "md:col-span-2 md:mx-auto md:w-full md:max-w-[calc((100%-2rem)/2)] xl:col-span-1 xl:max-w-none"
                  : ""
              }`}>
              {/* IMAGE */}
              ...
              <div className="pt-8">
                ...
                {/* TITLE */}
                <h3 className="mt-6 font-yeseva text-[28px] leading-[1.1] text-[#541f5c] lg:w-[420px] mx-auto">
                  <Link
                    href={post.href}
